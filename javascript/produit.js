...
var flag = 0;                        // Déclaration d'une variable - flag qui servira plus tard pour la page d'erreur
               ...
               if (flag == 1) {                             // Si le flag a été incrémenté, le contenu est généré
                teddyAppend.innerHTML +=
                    `<div class="teddyImport">
                        ...
                        <div class="${name}">
                            <section class="teddyInfo">
                                <h4 id="description">Description<br/>${description}</h4>
                                <h4 id="price">Prix<br/>${price/100}€</h4>
                            </section>
                            <img src="${imageUrl}" alt="Photo de ${name}" class="teddyPhoto"></img>

                            <div class="bloc_one">
                              <div class="quantityDiv">
                                <label for="quantityInput">Combien d'oursons ?</label><br />
